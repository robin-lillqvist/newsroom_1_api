  ...
  describe 'with valid stripe token' do
    describe "successfully" do
        ...
        it 'receives success message' do
          expect(response_json).to eq { status'paid' }
        end
        ...
        it 'creates a subscription for a s'
      end
    end
  ...
  describe "unsuccessfully" do
    ...
    describe 'when user is not signed in' do
      ...
      it 'returns message to sign in or register first' do
        expect(response_json["errors"][0]).to eq 'Please register or sign in before continuing.'
      end
    end
  end
end 